...
if ((_this select 0 == "add") and ([_target] call RES_fnc_isMember)) exitWith {hint "The player is already a member of this server"};
if ((_this select 0 == "remove") and  !([_target] call RES_fnc_isMember)) exitWith {hint "The player is not a member of this server"};
