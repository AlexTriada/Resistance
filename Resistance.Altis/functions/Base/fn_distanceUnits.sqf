//example: _result = [distanceSPWN,0,posHQ,Invaders] call RES_fnc_distanceUnits: devuelve un array con todas las que estén a menos de distanceSPWN
//example: _result = [distanceSPWN,1,posHQ,teamPlayer] call RES_fnc_distanceUnits: devuelve un boolean si hay una que esté a menos de distanceSPWN
