...
if ((_time - (boxX getVariable ["lastUsed", -30])) < 30) exitWith {
	if (hasInterface) then {
		hint "Этот ящик использовался 30 сек назад. Надо немного подождать!";
	};
};
...
hint "Все юниты рядом вылечены и готовы к бою. Ближайшие транспортные средства были отремонтированы, перевооружены и заправлены."
