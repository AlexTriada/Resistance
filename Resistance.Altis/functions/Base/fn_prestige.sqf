...
//if ((_natoT == floor _natoT) or (_csatT == floor _csatT)) then {[] remoteExec ["RES_fnc_statistics",[teamPlayer,civilian]]};
...
if (_textX != "") then {[petros,"income",_textX] remoteExec ["RES_fnc_commsMP",theBoss]};
