...
// EG: [_instigator, 20, 0.34] remoteExec ["RES_fnc_punishment",_instigator];
/*
...
/*
	...
	[cursorTarget, 0, 0] remoteExec ["RES_fnc_punishment",cursorTarget];		//ping
	[cursorTarget,120, 1] remoteExec ["RES_fnc_punishment",cursorTarget];		//Insta Punish, 120 seconds
	[cursorTarget,-99999, -1] remoteExec ["RES_fnc_punishment",cursorTarget];	//Insta Forgive
