...
if (count hcArray == 0) exitWith {[petros,"hint","No Headless Client Detected"] remoteExec ["RES_fnc_commsMP",theBoss]};
_textX = "";
...
[petros,"hint",_textX] remoteExec ["RES_fnc_commsMP",theBoss];
