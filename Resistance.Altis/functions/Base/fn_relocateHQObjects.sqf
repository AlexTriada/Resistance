...
[respawnTeamPlayer, 1, teamPlayer] call RES_fnc_setMarkerAlphaForSide;
[respawnTeamPlayer, 1, civilian] call RES_fnc_setMarkerAlphaForSide;
...
private _firePos = [_newPosition, 5, getDir petros] call BIS_Fnc_relPos;
//Extra height on the fire to avoid it clipping into the ground
fireX setPos (_firePos vectorAdd [0,0,0.1]);
_rnd = getdir petros;
_pos = [_firePos, 5, _rnd] call BIS_Fnc_relPos;
boxX setPos _pos;
_rnd = _rnd + 45;
_pos = [_firePos, 5, _rnd] call BIS_Fnc_relPos;
